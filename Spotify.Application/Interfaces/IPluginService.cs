...
public interface IPluginService
{
    ...
    Task<PluginResponse> CreatePluginAsync(CreatePluginRequest request, CancellationToken cancellationToken = default);
    ...
    Task<bool> DeletePluginAsync(Guid id, CancellationToken cancellationToken = default);
}