...
namespace Spotify.Infrastructure.Migrations
{
    ...
    [Migration("20260920081657_LikedAndAudioContetnFixed")]
    partial class LikedAndAudioContetnFixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spotify.Domain.Entities.Content.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("BioImageItemId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BioImageItemId");

                    b.HasIndex("ExternalAuthorId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Spotify.Domain.Entities.Content.PodcastAuthor", b =>
                {
            ...
            modelBuilder.Entity("Spotify.Domain.Entities.Content.Author", b =>
                {
                    b.HasOne("Spotify.Domain.Entities.Content.ImageItem", "BioImageItem")
                        .WithMany()
                        .HasForeignKey("BioImageItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Spotify.Domain.Entities.User.ApplicationUser", "User")
                        .WithOne("Author")
                        .HasForeignKey("Spotify.Domain.Entities.Content.Author", "UserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("BioImageItem");
            ...
            modelBuilder.Entity("Spotify.Domain.Entities.Content.AuthorContent", b =>
                {
                    b.HasOne("Spotify.Domain.Entities.Content.AudioContent", "Item")
                        .WithOne("AuthorContent")
                        .HasForeignKey("Spotify.Domain.Entities.Content.AuthorContent", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Spotify.Domain.Entities.Content.AuthorContentAuthor", b =>
                {
                    ...
                    b.HasOne("Spotify.Domain.Entities.Content.Author", "Author")
            ...
            modelBuilder.Entity("Episode", b =>
                {
                    b.HasOne("Spotify.Domain.Entities.Content.Audiobook", "Audiobook")
                        .WithMany("Episodes")
